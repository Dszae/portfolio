...
function ScrollToTopButton() {
  ...
  return (
    <button
      ...
      className="fixed bottom-6 right-6 z-50 p-3.5 bg-blue-600 hover:bg-blue-500 text-white rounded-xl shadow-[0_0_20px_rgba(3,177,252,0.4)] transition-all duration-300 hover:-translate-y-1 flex items-center justify-center cursor-pointer border border-blue-400/30 backdrop-blur-md"
    >
